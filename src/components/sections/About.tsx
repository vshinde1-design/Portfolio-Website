    ...
    <ScrollColorSection id="about" className="relative section-wrapper scroll-mt-24 py-12 md:py-16 mx-auto max-w-6xl px-4 md:px-6 mt-24 md:mt-32">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6 text-slate-100">
          ...
          {[
            <p key="p1" className="mt-4 text-[1.125rem] leading-7 text-slate-100/90">I recently completed my Master's in Information Systems at Stevens Institute of Technology, graduating with a 3.94 GPA and induction into Beta Gamma Sigma. Over the past two years, I've focused on using data to solve real operational problems—not only building dashboards but changing how decisions actually get made.</p>,
            <p key="p2" className="mt-4 text-[1.125rem] leading-7 text-slate-100/90">My work spans transportation, retail, and facilities. These are environments where the data is messy, the timelines are tight, and the analysis has to hold up in practice. I build Python and SQL pipelines, design Power BI dashboards for KPI tracking, and apply forecasting and statistical models to surface demand patterns, service gaps, and performance trends.</p>,
            <p key="p3" className="mt-4 text-[1.125rem] leading-7 text-slate-100/90">What drives me is the gap between raw data and a decision someone can actually act on. I'm at my best in fast-moving roles where the questions are still taking shape and the data isn't clean, because that's where clear analytical thinking makes the biggest difference.</p>,
